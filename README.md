...
One Second A Day is a free, open-source app for families who want to document life one moment at a time. All data stays on your device — no accounts, no cloud, no tracking. It is developed and maintained by OpenHearth, a nonprofit nonprofit building free tools for families.
...
OpenHearth is a nonprofit nonprofit dedicated to strengthening families through policy research, education, and free public tools.
