// Canonical responsive-golden sweep helper (copied from the visual-loop skill
// template). `goldenAtSizes` renders a screen/widget as `MaterialApp.home`
// across a size × textScale matrix and writes/compares one golden PNG per cell.
// All visual tests in this directory import this single helper — an earlier
// `child:`-signature variant and a transitional `_v2` copy have been unified
// away into this file.
